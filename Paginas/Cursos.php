    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            ';
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Paginas/Archivos.php">Reporte-<br>Terminacion-Materias</a>
                        <a class="collapse-item" href="#">Pagos</a>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <a class="text-xs font-weight-bold text-primary text-uppercase mb-1"
                                            href="Validar-Datos.php">
                                            DESARROLLO DE SOFTWARE</a>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Docente: Jairo Alberto
                                            Fuentes</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <a class="text-xs font-weight-bold text-success text-uppercase mb-1"
                                            href="Validar-Datos.php">
                                            CCNA-CISCO</a>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Docente: Jose Julian Forero
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-calendar fa-2x text-gray-300"></i>
